...
namespace E_Commerce.DAL.Migrations
{
    ...
    [Migration("20240802205251_Orders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Commerce.DAL.Models.Identity.AppUser", b =>
                {
            ...
            modelBuilder.Entity("E_Commerce.DAL.Models.ShippingMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Commerce.DAL.Models.Order", b =>
                {
                    b.HasOne("E_Commerce.DAL.Models.Identity.AppUser", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("E_Commerce.DAL.Models.ShippingMethod", "ShippingMethod")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("E_Commerce.DAL.Models.Identity.AppUser", null)
                        .WithMany()
